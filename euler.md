Here is an elementary derivation (without calculus) of [Euler's formula](https://en.wikipedia.org/wiki/Euler's_formula) <img src="https://latex.codecogs.com/gif.latex?e^{ix}=\cos{x}+i\sin{x}">.
