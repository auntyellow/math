...
5. For Pappus's theorem, [here](projective/pappus-v.py) is a vector space proof, and [here](projective/pappus-h.py) is a proof of by homogeneous coordinates without linear algebra; [here](projective/pappus-c1.py) and [here](projective/pappus-c2.py) are proofs by Cartesian coordinates.