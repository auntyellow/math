...
def main():
    ...
    sphere_h = poly(sphere_l, (x, y, z))
    sphere_h = fraction(cancel(sphere_h.coeff_monomial(x**2)*x**2 + sphere_h.coeff_monomial(x*y)*x*y + \
        sphere_h.coeff_monomial(y**2)*y**2 + sphere_h.coeff_monomial(y*z)*y*z + \
        sphere_h.coeff_monomial(z**2)*z**2 + sphere_h.coeff_monomial(x*z)*x*z + \
        sphere_h.coeff_monomial(x)*x*w + sphere_h.coeff_monomial(y)*y*w + sphere_h.coeff_monomial(z)*z*w))[0]
